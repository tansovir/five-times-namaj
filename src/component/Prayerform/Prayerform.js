...
const Prayerform = (props) => {
    // console.log(props)
    const {salahOnChangeHandler, salahSubmitHandler} = props;
    return (
        <Form onSubmit={salahSubmitHandler} className="row mx-1 mx-md-0">
            <Form.Group onChange={salahOnChangeHandler} controlId="fojor" className='col-6 col-md-4 py-2 border rounded'>
            ...
            <Form.Group onChange={salahOnChangeHandler} controlId="juhor" className='col-6 col-md-4 py-2 border rounded'>
            ...
            <Form.Group onChange={salahOnChangeHandler} controlId="asor" className='col-6 col-md-4 py-2 border rounded'>
            ...
            <Form.Group onChange={salahOnChangeHandler} controlId="magrib" className='col-6 col-md-4 py-2 border rounded'>
            ...
            <Form.Group onChange={salahOnChangeHandler} controlId="esha" className='col-6 col-md-4 py-2 border rounded'>
            ...
            <Form.Group onChange={salahOnChangeHandler} controlId="tahajjud" className='col-6 col-md-4 py-2 border rounded'>
